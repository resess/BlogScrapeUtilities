...
spiders = []
output_file_name = 'android_malware'
# tag = 'android_malice'
# tag = 'android_malicious'
tag = 'android_malware'
# tag = 'google_malice'
# tag = 'google_malicious'
# tag = 'google_malware'
# tag = 'play_store_malice'
# tag = 'play_store_malicious'
# tag = 'play_store_malware'
# tag = 'playstore_malice'
# tag = 'playstore_malicious'
# tag = 'playstore_malware'
...
def main():
    ...
    static_config_file = open(os.path.join(main_dir, 'config', 'static_config_{0}.yaml'.format(tag)), 'r', encoding='UTF-8')
    static_config = yaml.load(static_config_file)
    dynamic_config_file = open(os.path.join(main_dir, 'config', 'dynamic_config_{0}.yaml'.format(tag)), 'r', encoding='UTF-8')
    ...
    for company_name in static_config:
        ...
        blog_file = main_dir + '/temp/base_urls_for_keywords/{0}_urls/'.format(tag) + company_name + 'Blogs.txt'
